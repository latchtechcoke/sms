...
<div class="form-check form-check-inline">
  ...
  <label class="form-check-label" for="inlineRadio2">No</label>
                            ...
                            <tr>
                                <td>
                                    <input type="checkbox" id="checkAll" /> Select all ( <?php echo count($contacts) ?>)
                    ...
                    <span class="float-left">
                        <input type="checkbox" value="{{$item->phone_number.'}'.$item->first_name}}" name="phone_numbers[]" /> {{$item->phone_number}} {{$item->first_name}} 
                    </span>
