...
<!-- Mirrored from knowledgepro.binatestation.com/pagination.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 18 Nov 2022 12:10:00 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <div class="page-wrapper org-theme toggled">
                        ...
                        <li class="sidebar-dropdown">
                            ...
                            <div class="sidebar-submenu">
                                <ul>
                                    ...
                                    <li class="active"><a href="documentation/pagination">Pagination</a></li>
                            ...
                            <ul class="navbar-nav mr-auto">
                                ...
                                <li class="nav-item dropdown active"><a class="nav-link dropdown-toggle" href="#" id="navbarDropdown-2" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Docs</a>
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown-2"> <a class="dropdown-item" href="alert">Alerts</a>
                                        ...
                                        <a class="dropdown-item active" href="pagination">Pagination</a>
                                    </div>
                                    <!-- end of dropdown-menu -->
                                </li>
                                <!-- end of nav-item -->
     ...
     =============================-->
            <div class="clearfix main-content">
                ...
                Overview 
               =============================-->
                    <section id="overview" class="section border-no-sec">
                        <h3>Overview</h3>
                ...
                =============================-->
                    <section id="disabled" class="section">
                        ...
                        <p>While the .disabled class uses pointer-events: none to try to disable the link functionality of s, that CSS property is not yet standardized and doesn’t account for keyboard navigation. As such, you should always add tabindex="-1" on disabled links and use custom JavaScript to fully disable their functionality.</p>
              ...
              =============================-->
                <div class="right-nav nav">
                    <nav> <a href="documentation/#overview">Overview</a>
                        <a href="documentation/#working">Working with icons</a>
                        <a href="documentation/#disabled">Disabled and active states</a>
                        <a href="documentation/#alignment">Alignment</a>
                    </nav>
                </div>
                <!-- end of right-nav -->
                <!--=============================
