...
<!-- Mirrored from knowledgepro.binatestation.com/article-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 18 Nov 2022 12:09:50 GMT -->
<head>
    <meta charset="utf-8">
...
<body>
    ...
    <div class="doc-head-section">
        <div class="upper-head">
            <div class="container">
                ...
                <p>Learn more about the team maintaining Bootstrap, how and why the project started, and how to get involved.</p>
            </div>
            <!-- end of container -->
        </div>
        <!-- end of upper-head -->
    ...
    <div class="page-wrapper org-theme toggled">
        ...
        <div class="main-content-inner">
            <div class="container">
                <div data-spy="scroll" data-target=".sidebar">
                    <div class="row">
                            ...
                            <div class="main-content-inner">
                                    ...
                                    <div class="created-atr">
                                        <div class="comment_atr clearfix">
                                            ...
                                            <div class="detail-atr">
                                                <h6>Daicy Joseph</h6>
                                                <p>Created: Sep 06, 2016 - Updated: Apr 26, 2017</p>
                                            </div>
                                            <!-- end of detail-atr -->
                                        </div>
                                        <!-- end of comment_atr -->
                              ...
                              ===================-->
                                <section id="Quick_Start">
                                    ...
                                    <ul class="pro-ul">
                                        <li>
                                            <p>Click your team name to open the Team Menu.</p>
                                        </li>
                                        <li>
                                            <p>Select Profile & account. This will open your profile on the right side of your screen.</p>
                                        </li>
                                        <li>
                                            <p>Under your name, click Account Settings. This will open your Account settings.</p>
                                        </li>
                                        <li>
                                            <p>By Password, click expand.</p>
                                        </li>
                                        <li>
                                            <p>Enter your Current Password, and then a New Password.</p>
                                        </li>
                                        <li>
                                            <p>Click Save Password.</p>
                                        </li>
                                    </ul>
                                </section>
                                <!-- end of Quick_Start -->
                              ...
                              leave_cmt 
                              ===================-->
                                <section class="leave_cmt clearfix" id="Leave_Comments">
...
<!-- Mirrored from knowledgepro.binatestation.com/article-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 18 Nov 2022 12:10:00 GMT -->
</html>