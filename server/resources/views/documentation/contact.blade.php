...
<!-- Mirrored from knowledgepro.binatestation.com/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 18 Nov 2022 12:10:01 GMT -->
<head>
    <meta charset="utf-8">
                            ...
                            <ul class="navbar-nav mr-auto">
                                ...
                                <li class="nav-item dropdown active">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown-1"> <a class="dropdown-item" href="article">Article-1</a>
                                        ...
                                        <a class="dropdown-item active" href="contact">Contact</a>
                    ...
                    <form>
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="submit" name="submit_btn" value="Sumbit">
                            </div>
                            <!-- end of col-md-12 -->
                        </div>
                        <!-- end of row -->
