...
<!-- Mirrored from knowledgepro.binatestation.com/bootstrap-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 18 Nov 2022 12:10:01 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <!-- bootstrap css -->
    <link rel="stylesheet" type="text/css" href="/assets/documentation/assets/css/bootstrap-color.css">
...
<body>
    ...
    <div class="page-wrapper org-theme toggled bootstrap-color">
        <div class="doc-head-section set-2-doc-head">
            <div class="container">
                <!--======================
                  header 
                  ======================-->
                <div class="header bootstrap-head">
                    <nav class="navbar navbar-expand-lg light-navbar clearfix">
                        <a class="navbar-brand brand-name white-name" href="#">VedhaDocs</a>
                            ...
                            <ul class="navbar-nav mr-auto">
                                ...
                                <li class="nav-item dropdown active">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown"> <a class="dropdown-item" href="layout">Layout-1</a>
                                        ...
                                        <a class="dropdown-item active" href="bootstrap-2">Minimal</a>
                ...
                <div class="upper-head">
                    ...
                    <a href="documentation/#" class="btn start-btn">Getting Started</a>
                    <a href="documentation/#" class="btn download-btn">Downloads</a>
                </div>
                <!-- end of upper-head -->
            </div>
            <!-- end of container -->
        ...
        <!--==========================
            ...
            ==========================-->
        <section class="bootstrap-main-content">
            <div class="container">
                <div class="row">
                    <div class="col-md-3">
                        <!--======================
                        sidebar 
                        ======================-->
                        <nav id="sidebar" class="sidebar-wrapper relative-sidenav">
                            <div class="sidebar-content">
                                <div class="sidebar-menu">
                                    <ul>
                                        <li class="sidebar-dropdown">
                                            <a> <span>Getting Started</span>
                                            </a>
                                            <div class="sidebar-submenu">
                                                <ul>
                                                    <li><a href="documentation/introduction">Introduction</a>
                                                    </li>
                                                    <li><a href="documentation/content">Contents</a>
                                                    </li>
                                                    <li><a href="documentation/article">Article-1</a>
                                                    </li>
                                                    <li><a href="documentation/article-2">Article-2</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        ...
                                        <li class="sidebar-dropdown">
                                            ...
                                            <div class="sidebar-submenu">
                                                <ul>
                                                    <li><a href="documentation/layout">Overview</a>
                                                    </li>
                                                    <li><a href="documentation/approach">Approach</a>
                                                    </li>
                                                </ul>
                                            </div>
                                            <!-- end of sidebar-submenu -->
                                        ...
                                        <!-- end of sidebar-dropdown -->
                                        <li class="sidebar-dropdown">
                                            <a> <span>Components</span>
                                            </a>
                                            <div class="sidebar-submenu">
                                                <ul>
                                                    <li><a href="documentation/alert">Alerts</a>
                                                    </li>
                                                    <li><a href="documentation/pagination">Pagination</a>
                                                    </li>
                                                    <li><a href="documentation/404">404</a>
                                                    </li>
                                                    <li><a href="documentation/badge">Badge</a>
                                                    </li>
                                                    <li><a href="documentation/faq">FAQ</a>
                                                    </li>
                                                    <li><a href="documentation/login">Login</a></li>
                                                    <li><a href="documentation/sign-up">Sign Up</a></li>
                                                    <li><a href="documentation/typography">Typography</a>
                                                    </li>
                                                </ul>
                                            </div>
                                            <!-- end of sidebar-submenu -->
                                        ...
                                        <li class="sidebar-dropdown">
                                            ...
                                            <div class="sidebar-submenu">
                                                <ul>
                                                    <li><a href="documentation/bootstrap">Bootstrap</a>
                                                    </li>
                                                    <li><a href="documentation/bootstrap-2">Bootstrap lite</a>
                                                    </li>
                                                    <li><a href="documentation/semantic">Semantic</a>
                                                    </li>
                                                    <li><a href="documentation/badge">Badge</a>
                                                    </li>
                                                    <li><a href="documentation/contact">Contact</a>
                                                    </li>
                                                </ul>
                                            </div>
                                            <!-- end of sidebar-submenu -->
                    ...
                    <div class="col-md-9">
                        ...
                        page-content
                        ==========================-->
                        <div class="page-content set-2-page-content">
   ...
   <code>$ gem install bootstrap -v 4.3.1</code></pre>
                                 ...
                                 ==========================-->
                                    <section id="compile" class="section">
                                        ...
                                        <p>Download ready-to-use compiled code for <code>Bootstrap v4.3.1</code> to easily drop into your project, which includes:</p>
                                        <ul class="pro-ul">
                                            <li>
                                        ...
                                        <p>Should you require build tools, they are included for developing Bootstrap and its docs, but they’re likely unsuitable for your own purposes.</p>
                                    </section>
                                    <!-- end of compile -->
                                    <!--==========================
                                 package
                                 ==========================-->
                                    <section id="package" class="section">
                                        ...
                                        <p>Pull in Bootstrap’s source files into nearly any project with some of the most popular package managers. No matter the package manager, Bootstrap will require a Sass compiler and Autoprefixer for a setup that matches our official compiled versions.</p>
                                        <h4>npm</h4>
                                        <p>Install Bootstrap in your Node.js powered apps with the npm package:</p>
                                        <pre>
  <code>$ npm install bootstrap</code></pre>
                                        ...
                                        <ul class="pro-ul">
                                            ...
                                            <li>
                                                <p><code>style</code> - path to Bootstrap’s non-minified CSS that’s been precompiled using the default settings (no customization)</p>
                                            </li>
                                        </ul>
                                    </section>
                                    <!-- end of package -->
                                ...
                                <div class="right-nav nav right-min-nav">
                                    <nav> <a href="documentation/#install">Installation</a>
                                        <a href="documentation/#compile">Compiled CSS and JS</a>
                                        <a href="documentation/#package">Package managers</a>
                                    </nav>
                                </div>
                                <!-- end of right-nav -->
                            </div>
    ...
    chat-box
    =============================-->
                            <div id="body" class="bootstrap-chat">
