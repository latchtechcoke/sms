...
<!-- Mirrored from knowledgepro.binatestation.com/approach.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 18 Nov 2022 12:10:00 GMT -->
<head>
    <meta charset="utf-8">
            ...
            <div class="sidebar-content">
                ...
                <div class="sidebar-menu">
                    <ul>
                        ...
                        <li class="side-list active"><a href="documentation/approach">Approach</a></li>
                        <li class="sidebar-dropdown">
        ...
        <main class="page-content">
            <div class="doc-head-section">
                ...
                <div class="upper-head">
                    <h3>Approach</h3>
                    <p>Learn about the guiding principles, strategies, and techniques used to build and maintain Bootstrap so you can more easily customize and extend it yourself.</p>
                </div>
                <!-- end of upper-head -->
            </div>
            ...
            <div class="clearfix main-content">
                <div class="content-section">
                    <!--=============================
                     border-no-sec
                     =============================-->
                    <section id="summary" class="section border-no-sec">
                        <h3>Summary</h3>
                        ...
                        <ul class="pro-ul">
                            <li>
                                <p>Components should be responsive and mobile-first</p>
                            </li>
                            <li>
                                <p>Components should be built with a base class and extended via modifier classes</p>
                            </li>
                            <li>
                                <p>Component states should obey a common z-index scale</p>
                            </li>
                            <li>
                                <p>Whenever possible, prefer a HTML and CSS implementation over JavaScript</p>
                            </li>
                            <li>
                                <p>Whenever possible, use utilities over custom styles</p>
                            </li>
                            <li>
                                <p>Whenever possible, avoid enforcing strict HTML requirements (children selectors)</p>
                            </li>
                        </ul>
                    </section>
                    ...
                    <section id="responsive" class="section">
                        <h3>Responsive</h3>
                        <p>Bootstrap’s responsive styles are built to be responsive, an approach that’s often referred to as mobile-first. We use this term in our docs and largely agree with it, but at times it can be too broad. While not every component must be entirely responsive in Bootstrap, this responsive approach is about reducing CSS overrides by pushing you to add styles as the viewport becomes larger.</p>
                    ...
                    <!--=============================
                     html_css 
                     =============================-->
                    <section id="html_css" class="section">
                        <h3>HTML and CSS over JS</h3>
                        ...
                        <p>Lastly, our styles build on the fundamental behaviors of common web elements. Whenever possible, we prefer to use what the browser provides. For example, you can put a .btn class on nearly any element, but most elements don’t provide any semantic value or browser functionality. So instead, we use <code>&lt;button&gt;</code> and <code>&lt;a&gt;</code>.</p>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
                    </section>
                </div>
                <!-- end of content-section -->
                <div class="right-nav nav">
                    <nav> <a href="documentation/#summary">Summary</a>
                        <a href="documentation/#responsive">Responsive</a>
                        <a href="documentation/#classes">Classes</a>
                        <a href="documentation/#overlay">Overlay components</a>
                        <a href="documentation/#html_css">HTML and CSS over JS</a>
                    </nav>
                </div>
                <!-- end of right-nav -->
                <!--=============================
