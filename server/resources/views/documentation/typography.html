...
<!-- Mirrored from knowledgepro.binatestation.com/typography.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 18 Nov 2022 12:10:00 GMT -->
<head>
    <meta charset="utf-8">
     ...
     =============================-->
        <main class="page-content">
            <div class="doc-head-section">
                <div class="header">
                    <nav class="navbar navbar-expand-lg navbar-light with-sidebar"> <a class="navbar-brand brand-name" href="#">VedhaDocs</a>
                            ...
                            <ul class="navbar-nav mr-auto">
                                ...
                                <li class="nav-item dropdown active"><a class="nav-link dropdown-toggle" href="#" id="navbarDropdown-2" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Docs</a>
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown-2"> <a class="dropdown-item" href="alert.html">Alerts</a>
                                        <a class="dropdown-item active" href="typography.html">Typography</a>
         ...
         =============================-->
            <div class="clearfix main-content">
                <div class="content-section">
                  ...
                  border-no-sec
                  ============================= -->
                    <section id="heading" class="section border-no-sec">
                        <h3>Headings</h3>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <p><code class="highlighter-rouge">&lt;h1&gt;&lt;/h1&gt;</code>
                                            </p>
                                        </td>
                                        <td><span class="h1">h1. Bootstrap heading</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <p><code class="highlighter-rouge">&lt;h2&gt;&lt;/h2&gt;</code>
                                            </p>
                                        </td>
                                        <td><span class="h2">h2. Bootstrap heading</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <p><code class="highlighter-rouge">&lt;h3&gt;&lt;/h3&gt;</code>
                                            </p>
                                        </td>
                                        <td><span class="h3">h3. Bootstrap heading</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <p><code class="highlighter-rouge">&lt;h4&gt;&lt;/h4&gt;</code>
                                            </p>
                                        </td>
                                        <td><span class="h4">h4. Bootstrap heading</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <p><code class="highlighter-rouge">&lt;h5&gt;&lt;/h5&gt;</code>
                                            </p>
                                        </td>
                                        <td><span class="h5">h5. Bootstrap heading</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <p><code class="highlighter-rouge">&lt;h6&gt;&lt;/h6&gt;</code>
                                            </p>
                                        </td>
                 ...
                 ============================= -->
                    <section id="lead" class="section">
                        <h3>Lead</h3>
                        <p>Make a paragraph stand out by adding <code>.lead</code>
                        </p>
...
<span class="nt">&lt;/p&gt;</span>
                  ...
                  inline_text 
                  =============================-->
                    <section id="inline_text" class="section">
                        <h3>Inline text elements</h3>
                        <p>Styling for common inline HTML5 elements.</p>
                        <div class="knw-example">
                    ...
                    <!-- end of section -->
                    <section id="blockquotes" class="section">
                        <h3>Blockquotes</h3>
  ...
  <span class="nt">&lt;p</span> <span class="na">class=</span><span class="s">"mb-0"</span><span class="nt">&gt;</span>Lorem ipsum dolor sit amet,consectetur adipiscing elit.
  Integer posuere erat a ante.<span class="nt">&lt;/p&gt;</span>
<span class="nt">&lt;/blockquote&gt;</span></code></pre>
                        </figure>
                    </section>
                    <!-- end of section -->
                    <section id="font_size" class="section">
                        <h3>Responsive font sizes</h3>
                        <p>Bootstrap v4.3 ships with the option to enable responsive font sizes, allowing text to scale more naturally across device and viewport sizes. RFS can be enabled by changing the <code>$enable-responsive-font-sizes</code> Sass variable to true and recompiling Bootstrap.</p>
                        <p>To support RFS, we use a Sass mixin to replace our normal <code>font-size</code> properties. Responsive font sizes will be compiled into <code>calc()</code> functions with a mix of <code>rem</code> and viewport units to enable the responsive scaling behavior.</p>
                    </section>
                    <!-- end of section -->
                </div>
                <!-- end of content-section -->
                <div class="right-nav nav">
                    <nav> <a href="#heading">Headings</a>
                        <a href="#lead">Lead</a>
                        <a href="#inline_text">Inline text elements</a>
                        <a href="#blockquotes">Blockquotes</a>
                        <a href="#font_size">Responsive font sizes</a>
                    </nav>
                    <!-- end of nav -->
                </div>
                <!-- end of right-nav -->
