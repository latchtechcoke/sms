                ...
                <div class="sidebar-menu">
                    <ul>
                        <li class="sidebar-dropdown">
                            ...
                            <div class="sidebar-submenu">
                                <ul>
                                    ...
                                    <li><a href="content.html">Contents</a>
                                    </li>
                                    <li><a href="article.html">Article-1</a>
                                    </li>
                                    <li><a href="article-2.html">Article-2</a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <li class="sidebar-dropdown">
                            ...
                            <div class="sidebar-submenu">
                                <ul>
                                    <li><a href="layout.html">Overview</a>
                                    </li>
                                    <li><a href="approach.html">Approach</a>
                                    </li>
                                </ul>
                            </div>
                            <!-- end of sidebar-submenu -->
                        ...
                        <li class="sidebar-dropdown">
                            ...
                            <div class="sidebar-submenu">
                                <ul>
                                    <li><a href="bootstrap.html">Bootstrap</a>
                                    </li>
                                    <li><a href="bootstrap-2.html">Bootstrap lite</a>
                                    </li>
                                    <li><a href="semantic.html">Semantic</a>
                                    </li>
                                    <li><a href="badge.html">Badge</a>
                                    </li>
...
<code>$ npm install bootstrap</code>  </pre>
                ...
                <div class="right-nav nav">
                    <nav> <a href="#install">Installation</a>
                        <a href="#compile">Compiled CSS and JS</a>
