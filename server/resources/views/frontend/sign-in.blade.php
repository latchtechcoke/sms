        ...
        <div class="container">
            <div class="account-wrapper">
                <div class="account-area">
                    <h3 class="account-title">sign-in your account</h3>
                    <form class="sign-in-form">
                        <div class="form-group">
                            <input type="text" placeholder="User Name or Email">
                        </div>
                        <div class="form-group">
                            <input type="password" placeholder="Password" id="my-input-01">
                    ...
                    <div class="forget-pass-group d-flex flex-wrap justify-content-between">
                        ...
                        <div class="no-account">
                            <p>Have Not Account in Here? <a href="registration">Sign-Up</a></p>
                        </div>
                    </div>
                </div>
            </div>
