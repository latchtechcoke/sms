...
<!-- country-coverage.html   03:27:27 GMT -->
<head>
    <meta charset="UTF-8">
    ...
    <link rel="stylesheet" href="/assets/frontend/css/jqvmap.min.css">
...
<body>
    ...
    <section class="hero-area bg_img" data-background="/assets/frontend/images/page-header.jpg">
        <div class="container">
            <h1 class="title m-0">country coverage</h1>
        </div>
    </section>
    ...
    <section class="country-coverage-section padding-top">
        <div class="container">
            <div class="section-header">
                <h2 class="title">Our Bulk SMS service have all over the world</h2>
                <p>Penatibus posuere nec euismod massa ac. Tellus pellentesque porttitfelis eget velit aliquam minima dos sollicitudin, mus quam ridicodales tincidunt vel primis ornarevelit massa.</p>
            </div>
            <div id="vmap">
            ...
            <div class="row mb-30-none justify-content-center">
                ...
                <div class="col-md-6 col-sm-10 col-lg-4">
                    <div class="country-item">
                        <h4 class="title">african countries</h4>
                        <ol>
                            <li>
                                south africa
                            </li>
    ...
    <script src="/assets/frontend/js/jquery.vmap.min.js"></script>
    <script src="/assets/frontend/js/jquery.vmap.world.js"></script>
...
<!-- country-coverage.html   03:27:29 GMT -->
</html>