...
<body>
    ...
    <section class="banner-section">
        ...
        <div class="maps-shape bg_img bg-contain" data-background="/assets/frontend/images/banner/banner-bg01.png"></div>
        <div class="shape-thumb">
            <img class="wow slideInUp" data-wow-delay=".7s" src="/assets/frontend/images/banner/banner-shape01.png" alt="banner">
        </div>
    </section>
    <!-- =============Banner Section============= -->
                    ...
                    <div class="post-item wow fadeInUp" data-wow-delay=".3s">
                        <div class="post-item">
                            ...
                            <div class="post-content">
                                ...
                                <a class="read-more" href="blog-details">read More <i class="fas fa-caret-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
