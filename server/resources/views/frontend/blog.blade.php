...
<body>
    ...
    <section class="hero-area bg_img" data-background="/assets/frontend/images/page-header.jpg">
        <div class="container">
            <h1 class="title m-0">blog post - 01</h1>
        </div>
    </section>
            ...
            <div class="row mb-30-none justify-content-center">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="post-item">
                        ...
                        <div class="post-content">
                            <h4 class="title">
                                <a href="blog">Enteger a quam scele
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="post-item">
                        ...
                        <div class="post-content">
                            <h4 class="title">
                                <a href="blog">Placerat vitae nullam amquisduis</a>
                            </h4>
                            <p>pede augue peltesqvolpegesed sed. Et neque rhonctritiqultieam nunc, vitae
                                consectetueMauorbi aenean non maecenas</p>
                            <a class="read-more" href="blog-details">read more <i
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="post-item">
                        ...
                        <div class="post-content">
                            <h4 class="title">
                                <a href="blog">Dictum dolor nec nam aetorci praesent.</a>
                            </h4>
                            <p>pede augue peltesqvolpegesed sed. Et neque rhonctritiqultieam nunc, vitae
                                consectetueMauorbi aenean non maecenas</p>
                            <a class="read-more" href="blog-details">read more <i
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="post-item">
                        <div class="post-thumb">
                            <a href="blog">
                                <img src="/assets/frontend/images/blog/blog09.jpg" alt="blog">
                            </a>
                            <div class="post-date">
                                <span>31</span>
                                <span>dec</span>
