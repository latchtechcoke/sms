...
<body>
    ...
    <section class="hero-area bg_img" data-background="/assets/frontend/images/page-header.jpg">
        <div class="container">
            <h1 class="title m-0">masking SMS</h1>
        </div>
    </section>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="bulk-thumb">
                        <img src="/assets/frontend/images/bulk/bulk02.png" alt="bulk">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="bulk-content text-center text-sm-left">
                        <span>services Benefits</span>
                        <h2 class="title">what's Benefits masking SMS</h2>
    ...
    <section class="bulk-sms padding-top">
        <div class="container">
            <div class="row flex-wrap-reverse align-items-center">
                <div class="col-lg-6">
                    <div class="bulk-content text-center text-sm-left">
                        ...
                        <p>Mauris iaculis pede, tellus commodo justo. Ligula in tortmris libero lectus libero
                            aliquet, vestibulum aut nullloret ac sictus, id pede quis quisque lacinia consectetuer.
                            uere eros velit eu nec arcu, repellat urna ad odio nunc. Doletiarcu eginrdum tiunt
                            morbi, aenean dui amet at mapro Sed quis nunc est justo, in in, elit lorem vulputate,
                            suspendisse pellentesque pede tpluptatem ut mattis, eros diam litora nullam. Ac cras,
                ...
                <div class="col-lg-6">
                    <div class="bulk-thumb">
                        <img src="/assets/frontend/images/bulk/bulk01.png" alt="bulk">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="feature-section padding-top padding-bottom">
        <div class="container">
            <div class="section-header">
                ...
                <h2 class="title">masking SMS feature</h2>
            </div>
            <div class="feature-section-wrapper">
                ...
                <div class="feature-area">
                    <img src="/assets/frontend/images/feature/feature01.png" alt="feature">
                </div>
                <div class="feature-area">
                    <div class="feature-item">
                        <div class="icon">
    ...
    <section class="service-process padding-top">
        <div class="container">
            <div class="section-header">
